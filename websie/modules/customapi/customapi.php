...
class Customapi extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Prestashop Custom API');
    ...
    {
        Configuration::updateValue('CUSTOMAPI_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('CUSTOMAPI_LIVE_MODE');
    ...
    {
        return array(
            'CUSTOMAPI_LIVE_MODE' => Configuration::get('CUSTOMAPI_LIVE_MODE', true),
